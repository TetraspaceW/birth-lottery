...
const humanPopulationData = {
    // Humans (latest figures from Wikipedia's list of countries and dependencies by population)
    ...
    thailand: { population: 70250751, category: "human", name: "🇹🇭 Human from Thailand" },
    ...
    angola: { population: 38778554, category: "human", name: "🇦🇴 Human from Angola" },
    ...
    ukraine: { population: 28700000, category: "human", name: "🇺🇦 Human from Ukraine" },
    ...
    mali: { population: 23929000, category: "human", name: "🇲🇱 Human from Mali" },
    ...
    zambia: { population: 23003214, category: "human", name: "🇿🇲 Human from Zambia" },
    ...
    senegal: { population: 19575061, category: "human", name: "🇸🇳 Human from Senegal" },
    ...
    guinea: { population: 17521167, category: "human", name: "🇬🇳 Human from Guinea" },
    ...
    portugal: { population: 11424031, category: "human", name: "🇵🇹 Human from Portugal" },
    ...
    "lebanon": { population: 5895466, category: "human", name: "🇱🇧 Human from Lebanon" },
    ...
    georgia: { population: 3941100, category: "human", name: "🇬🇪 Human from Georgia" },
    ...
    qatar: { population: 3370611, category: "human", name: "🇶🇦 Human from Qatar" },
    ...
    "guinea-bissau": { population: 1890252, category: "human", name: "🇬🇼 Human from Guinea-Bissau" },
    ...
    guyana: { population: 956044, category: "human", name: "🇬🇾 Human from Guyana" },
    ...
    "federated-states-of-micronesia": { population: 75817, category: "human", name: "🇫🇲 Human from the Federated States of Micronesia" },
...
const animalPopulationData = {
    // Farmed animals
    fish: { population: 222.6e9, category: "domestic", name: "🐟 Farmed fish", moralWeightKey: "fish" },
    ...
    hen: { population: 8.65e9, category: "domestic", name: "🐔🥚 Farmed egg-laying chicken", moralWeightKey: "chicken" },
    broiler: { population: 19.0e9, category: "domestic", name: "🐔 Farmed chicken", moralWeightKey: "chicken" },
    cow: { population: 1.58e9, category: "domestic", name: "🐄 Farmed cow", moralWeightKey: "cow" },
    duck: { population: 1.27e9, category: "domestic", name: "🦆 Farmed duck", moralWeightKey: "duck" },
    sheep: { population: 1.36e9, category: "domestic", name: "🐑 Farmed sheep", moralWeightKey: "sheep" },
    goat: { population: 1.19e9, category: "domestic", name: "🐐 Farmed goat", moralWeightKey: "goat" },
    pig: { population: 962e6, category: "domestic", name: "🐖 Farmed pig", moralWeightKey: "pig" },
    turkey: { population: 244e6, category: "domestic", name: "🦃 Farmed turkey", moralWeightKey: "turkey" },
    goose: { population: 383e6, category: "domestic", name: "🪿 Farmed goose", moralWeightKey: "goose" },
    rabbit: { population: 210e6, category: "domestic", name: "🐰 Farmed rabbit", moralWeightKey: "rabbit" },
    buffalo: { population: 212e6, category: "domestic", name: "🦬 Farmed buffalo", moralWeightKey: "buffalo" },
    ...
    "wild-shrimp": { population: 2.5e14, category: "wild", name: "🦐 Wild shrimp", moralWeightKey: "shrimp" },
