...
const populationData = {
    ...
    'chicken': { population: 74000000000, category: 'farmed', name: '🐔 Farmed chicken' },
    'pig': { population: 1500000000, category: 'farmed', name: '🐖 Farmed pig' },
    'cow': { population: 1500000000, category: 'farmed', name: '🐄 Farmed cow' },
    
    // Wild animals (very rough estimates)
    'wild-bird': { population: 100_000_000_000, category: 'wild', name: '🐦 Wild bird' },
    'wild-mammal': { population: 130_000_000_000, category: 'wild', name: '🐀 Wild mammal' },
    'wild-fish': { population: 1_000_000_000_000, category: 'wild', name: '🐟 Wild fish' },
...
function isIncluded(category) {
    if (category === 'human') return document.getElementById('includeHumans').checked;
    if (category === 'farmed') return document.getElementById('includeFarmedAnimals').checked;
    if (category === 'wild') return document.getElementById('includeWildAnimals').checked;
    return false;
}
